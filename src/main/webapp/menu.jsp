	...
	<nav class="navbar navbar-expand-lg navbar-light shadow">
		<div
			...
			<a class="navbar-brand text-success logo h1 align-self-center"
				href="index.html"> Squad Online Shopee </a>
				...
				<div class="flex-fill">
					<ul
						...
						<li class="nav-item"><a class="nav-link"
							href="customer?operation=viewCustomer">dashboard</a></li>
						<li class="nav-item"><a class="nav-link"
							href="customer?operation=editCustomer">edit</a></li>
						<li class="nav-item"><a class="nav-link"
							href="cart?operation=viewAllCarts">view Cart</a></li>
						<%
						...
						if (username != null && (userType.equalsIgnoreCase("customer") || userType.equalsIgnoreCase("admin"))) {
						%>
						<li class="nav-item"><a class="nav-link"
							href="product?operation=viewAllProducts">view all products</a></li>
						<li class="nav-item"><a class="nav-link"
							href="customer?operation=logout">logout</a></li>
						<%
						}
						%>
					</ul>
